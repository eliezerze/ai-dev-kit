"""Unity Catalog workflows - High-level UC operations including volume files.

This module contains the business logic for Unity Catalog operations,
used by both the MCP server and CLI. This includes volume file operations.
...
def manage_volume_files(
    ...
    Args:
        ...
        volume_path: Volume path (format: /Volumes/catalog/schema/volume/path/to/file_or_dir).
        local_path: Local path for upload (supports globs and tilde expansion).
        local_destination: Local path for download.
        max_results: Max results for list (default 500, max 1000).
        recursive: Allow recursive deletion.
        max_workers: Parallel workers for upload/delete.
