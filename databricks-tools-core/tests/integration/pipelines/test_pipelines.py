"""
Integration tests for manage_pipeline and manage_pipeline_run API.
...
from databricks_tools_core.spark_declarative_pipelines.pipelines_api import manage_pipeline, manage_pipeline_run
